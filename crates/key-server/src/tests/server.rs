...
use mys_types::crypto::{Ed25519KeyPair, Ed25519PrivateKey, KeypairTraits};
...
async fn test_fetch_key() {
    ...
    let user =
        MysAddress::from_str("0xb743cafeb5da4914cef0cf0a32400c9adfedc5cdb64209f9e740e56d23065100")
            .unwrap();
