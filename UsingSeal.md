...
Building and publishing the code can be done using the [`Mys CLI`](https://docs.mysocial.network/references/cli), e.g.,: 
```shell
cd examples/move
mys move build
...
- During Seal evaluation, only `seal_approve*` functions can be invoked directly. These functions should not assume composition with other [PTB (Programmable Transaction Block)](https://docs.mysocial.network/concepts/transactions/prog-txn-blocks) commands.
...
const txBytes = tx.build( { client: mysClient, onlyTransactionKind: true })
...
- mysten-testnet-1: https://seal-key-server-testnet-1.mysocial.network
- mysten-testnet-2: https://seal-key-server-testnet-2.mysocial.network
...
```shell
myso client call --function create_and_transfer_v1 --module key_server --package 0x62c79dfeb0a2ca8c308a56bde530ccf3846535e1623949d45c90d23128afff52 --args mysten-dev-1 https://seal-key-server-testnet-1.mysocial.network 0 0xa023acbf600401017ee17bf918106ea9911914ca017aa3ab9ab5c64beb9bb5236fd9d4d5b5645dc3bc0d4f732ed04fc60d14b9f37987fe5eeb4db07fc0982904ce1ed0b07607ae2e99086e141f6c6a1df6def5f5d434ca7c09856a3750c92969 --gas-budget 10000000
```
